...
description: "Tailscale을 이용하여 Proxmox를 유연하게 사용해보자"
date: 2025-01-05
---
...
사실 완전히 외부에서 제한 없이 접속 하는 방법으론 맞지 않지만, Tailscale의 ACL 등을 활용 한다면 충분히 더 활용 할 수 있을꺼라 생각 하여 이런 세팅을 하였다.   
...
여기서 본인의 발표할 서브넷 부분을 10.0.1.0/24 부분으로 변경 해주면 된다. 나는 [해당 글](https://hwanstory.kr/@kim-hwan/posts/Proxmox-Virtual-Private-Network-Configuration)을 통해 서브넷 대역을 만들었다.

이후, approve를 받아야 서브넷 접근을 가능하게 해두었다면, 어드민 콘솔 => 장치 탭 => 아래 이미지 부분을 통하여 해당 서브넷을 허용 해주자.
