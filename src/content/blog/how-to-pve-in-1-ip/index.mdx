...
여기서 본인의 발표할 서브넷 부분을 10.0.1.0/24 부분으로 변경 해주면 된다. 나는 [해당 글](https://hwanstory.kr/@kim-hwan/posts/Proxmox-Virtual-Private-Network-Configuration)을 참고하여 서브넷 대역을 만들었다.
